...
export default function JsonToSDL() {
  ...
  console.log(schema);
  return (<>
    <div className="not-content" style={{marginTop: '2rem', gap:'1rem', display: 'grid', gridTemplateColumns: "repeat(auto-fit, minmax(100px, 1fr))"}}>
    ...
    <button
    style={{ display: 'inline-block', padding: '.5rem 1rem', borderRadius: '4px', backgroundColor: 'var(--sl-color-text-accent)', color: 'var(--sl-color-black', margin: "0"}}
    onClick={() => {
      try {
